            ...
            <div class="modal-comment-bg" :key="commentload">
              ...
              <div class="comment-area2">
                <div id="comment-form">
                  ...
                  <button class="send-comment" @click="sendComment">
                    전송
                  </button>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    async sendComment() {
      ...
      axios
        .post(
          `http://${process.env.VUE_APP_BACK_END_URL}/addFeedComment`,
          this.formData
        )
        .then((res) => {
    ...
    feedUpdate() {
      ...
      axios.post(`http://${process.env.VUE_APP_BACK_END_URL}/feedUpdateForm`, formData)
      .then(res => {
