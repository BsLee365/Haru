              ...
              <ul>
                <li>
                  <div>
                    ...
                    <span class="alarm-time"
                      ><img
                        src="@/img/assets/icon/time_icon.png"
                        alt=""
                      />10분전</span
                    >
                  </div>
                ...
                <li>
                  <div>
                    <img
                      class="alarm-img"
                      src="@/img/assets/icon/login/kakao_login_icon.png"
                    />
                    <span id="comment-content">댓글 내용</span>
                    <span class="alarm-time"
                      ><img
				...
				<div class="mypage-left-box">
					<ul>
						...
						<li>
							...
							<div class="username-box">
								<span>별명을 가진</span><span id="username-tag">{{ userName }} 님</span>
							</div>
						</li>
						<li class="user-activity-info">
							<div class="commentCnt-box">
						...
						<div class="update-mydata-box">
							<a class="big-ctlbtn update-btn" href="/userConfirmation" id="updateMyDataBtn">내 정보 수정</a>
						</div>
					</ul>
				</div>
				<div class="mypage-right-box">
					<div class="alarm-area">
						...
						<div class="alarm-container">
							<ul v-for="(alarm, i) in alarmList" :key="i">
								<li>
									<div v-if="alarm.like != null" @click="toMyFeed(data.nickname, alarm.like.feed_num.feed_num)">
...
export default {
	...
	methods: {
		...
		getMyPageData() {
			...
			axios.post(`http://${process.env.VUE_APP_BACK_END_URL}/getMyPageData`, formData).then((res) => {
				console.log(res);
